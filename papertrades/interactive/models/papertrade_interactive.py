# papertrades.interactive.models.papertrade_interactive.py
...
class PaperTradeInteractive(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'), nullable=False)
    user = db.relationship('User', back_populates='paper_trades_interactive')
    ...
    def __repr__(self):
        return f"<PaperTradeInteractive id: {self.id}, asset: {self.asset}, timestamp: {self.timestamp}>"
